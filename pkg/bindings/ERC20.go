...
func (_ERC20 *ERC20Caller) MINTCAPDENOMINATOR(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _ERC20.contract.Call(opts, &out, "MINT_CAP_DENOMINATOR")
...
//
// Solidity: function MINT_CAP_DENOMINATOR() view returns(uint256)
func (_ERC20 *ERC20Session) MINTCAPDENOMINATOR() (*big.Int, error) {
	return _ERC20.Contract.MINTCAPDENOMINATOR(&_ERC20.CallOpts)
}

// MINTCAPDENOMINATOR is a free data retrieval call binding the contract method 0x89110e5d.
//
// Solidity: function MINT_CAP_DENOMINATOR() view returns(uint256)
func (_ERC20 *ERC20CallerSession) MINTCAPDENOMINATOR() (*big.Int, error) {
	return _ERC20.Contract.MINTCAPDENOMINATOR(&_ERC20.CallOpts)
}
...
func (_ERC20 *ERC20Caller) MINTCAPNUMERATOR(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _ERC20.contract.Call(opts, &out, "MINT_CAP_NUMERATOR")
...
//
// Solidity: function MINT_CAP_NUMERATOR() view returns(uint256)
func (_ERC20 *ERC20Session) MINTCAPNUMERATOR() (*big.Int, error) {
	return _ERC20.Contract.MINTCAPNUMERATOR(&_ERC20.CallOpts)
}

// MINTCAPNUMERATOR is a free data retrieval call binding the contract method 0xe6be4876.
//
// Solidity: function MINT_CAP_NUMERATOR() view returns(uint256)
func (_ERC20 *ERC20CallerSession) MINTCAPNUMERATOR() (*big.Int, error) {
	return _ERC20.Contract.MINTCAPNUMERATOR(&_ERC20.CallOpts)
}
...
func (_ERC20 *ERC20Caller) MINMINTINTERVAL(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _ERC20.contract.Call(opts, &out, "MIN_MINT_INTERVAL")
...
//
// Solidity: function MIN_MINT_INTERVAL() view returns(uint256)
func (_ERC20 *ERC20Session) MINMINTINTERVAL() (*big.Int, error) {
	return _ERC20.Contract.MINMINTINTERVAL(&_ERC20.CallOpts)
}

// MINMINTINTERVAL is a free data retrieval call binding the contract method 0xa9f8ad04.
//
// Solidity: function MIN_MINT_INTERVAL() view returns(uint256)
func (_ERC20 *ERC20CallerSession) MINMINTINTERVAL() (*big.Int, error) {
	return _ERC20.Contract.MINMINTINTERVAL(&_ERC20.CallOpts)
}
...
func (_ERC20 *ERC20Caller) L1Address(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _ERC20.contract.Call(opts, &out, "l1Address")
...
//
// Solidity: function l1Address() view returns(address)
func (_ERC20 *ERC20Session) L1Address() (common.Address, error) {
	return _ERC20.Contract.L1Address(&_ERC20.CallOpts)
}

// L1Address is a free data retrieval call binding the contract method 0xc2eeeebd.
//
// Solidity: function l1Address() view returns(address)
func (_ERC20 *ERC20CallerSession) L1Address() (common.Address, error) {
	return _ERC20.Contract.L1Address(&_ERC20.CallOpts)
}
...
func (_ERC20 *ERC20Caller) NextMint(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _ERC20.contract.Call(opts, &out, "nextMint")
...
//
// Solidity: function nextMint() view returns(uint256)
func (_ERC20 *ERC20Session) NextMint() (*big.Int, error) {
	return _ERC20.Contract.NextMint(&_ERC20.CallOpts)
}

// NextMint is a free data retrieval call binding the contract method 0xcf665443.
//
// Solidity: function nextMint() view returns(uint256)
func (_ERC20 *ERC20CallerSession) NextMint() (*big.Int, error) {
	return _ERC20.Contract.NextMint(&_ERC20.CallOpts)
}
...
func (_ERC20 *ERC20Transactor) Initialize(opts *bind.TransactOpts, _l1TokenAddress common.Address, _initialSupply *big.Int, _owner common.Address) (*types.Transaction, error) {
	return _ERC20.contract.Transact(opts, "initialize", _l1TokenAddress, _initialSupply, _owner)
}

// Initialize is a paid mutator transaction binding the contract method 0xc350a1b5.
//
// Solidity: function initialize(address _l1TokenAddress, uint256 _initialSupply, address _owner) returns()
func (_ERC20 *ERC20Session) Initialize(_l1TokenAddress common.Address, _initialSupply *big.Int, _owner common.Address) (*types.Transaction, error) {
	return _ERC20.Contract.Initialize(&_ERC20.TransactOpts, _l1TokenAddress, _initialSupply, _owner)
}

// Initialize is a paid mutator transaction binding the contract method 0xc350a1b5.
//
// Solidity: function initialize(address _l1TokenAddress, uint256 _initialSupply, address _owner) returns()
func (_ERC20 *ERC20TransactorSession) Initialize(_l1TokenAddress common.Address, _initialSupply *big.Int, _owner common.Address) (*types.Transaction, error) {
	return _ERC20.Contract.Initialize(&_ERC20.TransactOpts, _l1TokenAddress, _initialSupply, _owner)
}
...
func (_ERC20 *ERC20Transactor) TransferAndCall(opts *bind.TransactOpts, _to common.Address, _value *big.Int, _data []byte) (*types.Transaction, error) {
	return _ERC20.contract.Transact(opts, "transferAndCall", _to, _value, _data)
}

// TransferAndCall is a paid mutator transaction binding the contract method 0x4000aea0.
//
// Solidity: function transferAndCall(address _to, uint256 _value, bytes _data) returns(bool success)
func (_ERC20 *ERC20Session) TransferAndCall(_to common.Address, _value *big.Int, _data []byte) (*types.Transaction, error) {
	return _ERC20.Contract.TransferAndCall(&_ERC20.TransactOpts, _to, _value, _data)
}

// TransferAndCall is a paid mutator transaction binding the contract method 0x4000aea0.
//
// Solidity: function transferAndCall(address _to, uint256 _value, bytes _data) returns(bool success)
func (_ERC20 *ERC20TransactorSession) TransferAndCall(_to common.Address, _value *big.Int, _data []byte) (*types.Transaction, error) {
	return _ERC20.Contract.TransferAndCall(&_ERC20.TransactOpts, _to, _value, _data)
}
...
// ERC20Transfer0Iterator is returned from FilterTransfer0 and is used to iterate over the raw logs and unpacked data for Transfer0 events raised by the ERC20 contract.
type ERC20Transfer0Iterator struct {
	Event *ERC20Transfer0 // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *ERC20Transfer0Iterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *ERC20Transfer0Iterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *ERC20Transfer0Iterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// ERC20Transfer0 represents a Transfer0 event raised by the ERC20 contract.
type ERC20Transfer0 struct {
	From  common.Address
	To    common.Address
	Value *big.Int
	Raw   types.Log // Blockchain specific contextual infos
...
func (_ERC20 *ERC20Filterer) FilterTransfer0(opts *bind.FilterOpts, from []common.Address, to []common.Address) (*ERC20Transfer0Iterator, error) {
	...
	logs, sub, err := _ERC20.contract.FilterLogs(opts, "Transfer0", fromRule, toRule)
	if err != nil {
		return nil, err
	}
	return &ERC20Transfer0Iterator{contract: _ERC20.contract, event: "Transfer0", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event Transfer(address indexed from, address indexed to, uint256 value)
func (_ERC20 *ERC20Filterer) WatchTransfer0(opts *bind.WatchOpts, sink chan<- *ERC20Transfer0, from []common.Address, to []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _ERC20.contract.WatchLogs(opts, "Transfer0", fromRule, toRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(ERC20Transfer0)
				if err := _ERC20.contract.UnpackLog(event, "Transfer0", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event Transfer(address indexed from, address indexed to, uint256 value)
func (_ERC20 *ERC20Filterer) ParseTransfer0(log types.Log) (*ERC20Transfer0, error) {
	event := new(ERC20Transfer0)
	if err := _ERC20.contract.UnpackLog(event, "Transfer0", log); err != nil {
		return nil, err
	}
